...
async def rag_query_pdf_ai(ctx: inngest.Context):
    ...
    user_content = (
        ...
        f"Context:\n{context_block}\n\n"
        f"Question: {question}\n"
        "Answer concisely based on the context provided above."
    )
    ...
    res = await ctx.step.ai.infer(
        ...
        body = {
            ...
            "temperature": 0.2,
            "messages": [
                {"role": "system", "content": "Youn answer questions based on the provided context."},
    ...
    return {"answer": answer, "sources": found.sources, "number_contexts": len(found.contexts)}
